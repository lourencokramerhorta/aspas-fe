      ...
      <div className="container pt-5">
        <div className="shadow p-3 mb-5 bg-body rounded mt-5">
          <div className="d-flex align-items-start align-items-stretch">
            <div className="col-4">
              <img src={profileUser.imageUrl} className="rounded-3 w-100" />
            </div>
            <h1 className="userCardText">{profileUser.username}</h1>
            <div className="col-8 d-flex flex-column align-content-end mt-auto">
              <div className=" align-self-end">
                {isOwnProfile && (
                  <div>
                    <Link to="/create-place" className="me-3 btn btn-home">
                      Create Place
                    </Link>

                    <Link
                      to={`/user/${this.props.loggedInUser._id}/edit`}
                      className="me-3 btn btn-home"
                    >
                      edit profile
                    </Link>
                  </div>
